...
class AppTest {
    ...
    void createUser() throws IOException, ParseException {
        ...
        List<NameValuePair> params1 = new ArrayList<>();
        params1.add(new BasicNameValuePair("firstName", "Shoshana"));
        params1.add(new BasicNameValuePair("lastName", "Haley"));
        params1.add(new BasicNameValuePair("email", "shoshana.haley@hotmail.com"));
        postRequest1.setEntity(new UrlEncodedFormEntity(params1));
        client.execute(postRequest1);
        ...
        HttpPost postRequest2 = new HttpPost(baseUrl + "/users/list");
        List<NameValuePair> params2 = new ArrayList<>();
        params2.add(new BasicNameValuePair("firstName", "Shoshana"));
        params2.add(new BasicNameValuePair("lastName", ""));
        params2.add(new BasicNameValuePair("email", "shoshana.haley@hotmail.com"));
        postRequest2.setEntity(new UrlEncodedFormEntity(params2));
        client.execute(postRequest2);

        CloseableHttpResponse response2 = client.execute(postRequest2);
        assertThat(response2.getCode()).isEqualTo(422);
    }
    // END
